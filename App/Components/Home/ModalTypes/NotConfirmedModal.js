  ...
  renderModalContent = () => (
    <ScrollView style={Styles.modalView}>
      <View style={Styles.TopView}>
        <TouchableOpacity
          onPress={() => {
            this.props.closeNotConfirmedModal();
            this.props.ResetNotConfirm();
          }}>
      ...
      <View style={Styles.View1}>
        ...
        <TouchableOpacity
          onPress={() => {
            this.props.closeNotConfirmedModal();
            this.props.navigation.navigate('Chat', { Check: 'notConfirm' });
          }}
  ...
  render() {
    return (
      <SafeAreaView>
        ...
        <Modal
          isVisible={
            (this.props.NotConfirmedModalState || this.props.NotConfirm) === 'fancy'
