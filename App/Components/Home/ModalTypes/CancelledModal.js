  ...
  renderModalContent = () => (
    <View style={Styles.modalView}>
      <View style={Styles.TopView}>
        <TouchableOpacity
          onPress={() => {
            this.props.closeCancelledModal();
      ...
      <View style={Styles.View1}>
        ...
        <View style={Styles.TextView}>
          <Text style={Styles.DarkText}>
            I do not ship on time, therefore your order and your ticket is
            canceled, giving as a consequence, that you will not be able to buy
            and sell until paying a penalty
          </Text>
        </View>
        ...
        <View style={Styles.FooterView}>
          <TouchableOpacity
            onPress={() => {
              this.props.closeCancelledModal();
              this.props.navigation.navigate('Chat', { Check: 'cancel' });
            }}
  ...
  render() {
    return (
      <SafeAreaView>
        ...
        <Modal
          isVisible={(this.props.CancelledModalState || this.props.Cancel) === 'fancy'}
