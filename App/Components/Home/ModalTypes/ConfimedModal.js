  ...
  renderModalContent = () => (
    <View style={Styles.modalView}>
      <View style={Styles.TopView}>
        <TouchableOpacity
          onPress={() => {
            this.props.closeConfirmedModal();
            this.props.RestConfirm();
          }}>
      ...
      <View style={Styles.View1}>
        ...
        <View style={Styles.TextView}>
          <Text style={Styles.DarkText}>
            Your order has been successfully confirmed, you can see the
            following hash at any time for your safety
          </Text>
        </View>
        ...
        <View style={Styles.FooterView}>
          <TouchableOpacity
            onPress={() => {
              this.props.closeConfirmedModal();
              this.props.navigation.navigate('Chat', { Check: 'confirm' });
            }}
  ...
  render() {
    return (
      <SafeAreaView>
        ...
        <Modal
          isVisible={(this.props.ConfirmedModalState || this.props.Confirm) === 'fancy'}
