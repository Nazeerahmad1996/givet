  ...
  renderModalContent = () => (
    <View style={Styles.modalView}>
      <View style={Styles.TopView}>
        <TouchableOpacity
          onPress={() => {
            this.props.closeCancelledGradient();
            this.props.ResetCancelG();
          }}>
      ...
      <View style={Styles.View1}>
        ...
        <View style={Styles.TextView}>
          <Text style={Styles.DarkText}>
            We are sorry that the buyer has not made the payment on time, but
            you do not pre-claim your ticket is in a queue to assign it to
            another buyer as soon as it exists.
          </Text>
        </View>
        ...
        <View style={Styles.FooterView}>
          <TouchableOpacity
            onPress={() => {
              this.props.closeCancelledGradient();
              this.props.navigation.navigate('Chat', { Check: 'cancelG' });
            }}
          ...
          <View style={Styles.NotConfirmedView}>
            <TouchableOpacity style={Styles.NotConfirmedTouch}>
              <Text style={Styles.NotConfirmedText}>Cancelled</Text>
            </TouchableOpacity>
            <TouchableOpacity>
  ...
  render() {
    return (
      <SafeAreaView>
        ...
        <Modal
          isVisible={(this.props.CancelledGradient || this.props.CancelG) === 'fancy'}
